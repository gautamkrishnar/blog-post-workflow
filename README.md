...
| `disable_html_encoding` | `false` | Disables the html encoding of feed contents. | No |
...
- All the **3.8K+✨** [users](https://github.com/search?l=YAML&o=desc&q=gautamkrishnar%2Fblog-post-workflow&s=indexed&type=Code) of this workflow
